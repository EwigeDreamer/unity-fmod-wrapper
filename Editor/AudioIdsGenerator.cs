...
namespace ED.FMODWrapper.Editor
{
    public static class AudioIdsGenerator
    {
        ...
        private static string GenerateScript(Node tree)
        {
            ...
            sb.AppendLine($"// This script was generated by {typeof(AudioIdsGenerator).Namespace}.{nameof(AudioIdsGenerator)}");
            sb.AppendLine();
        ...
        private static void FillDataRecursively(Node node, System.Text.StringBuilder sb, int level)
        {
            ...
            sb.Append(indent);
            if (needInherit) sb.Append($"public sealed class {className} : {node.BaseType.Name}");
